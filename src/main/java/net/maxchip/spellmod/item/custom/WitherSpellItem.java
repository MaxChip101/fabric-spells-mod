...
public class WitherSpellItem extends Item {
    public WitherSpellItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient && user.experienceLevel > 0 || !world.isClient && user.isInCreativeMode()) {
            ...
            WitherSkullEntity bullet = new WitherSkullEntity(EntityType.WITHER_SKULL, world);
